  ...
  return (
    ...
    <div className='  mt-5 flex flex-col md:flex-row flex-wrap gap-4 '>
        <div className= {`name-intro md:w-3/5  px-7 py-5 rounded-2xl flex flex-col justify-center gap-3 ${dark ? 'bg-diagonal-lines border-solid border border-gray-800 ' : 'bg-white'} `}>
            ...
            <p className= {`font-light ${dark ? 'text-white' : 'text-gray-500'}`}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto praesentium, aspernatur accusamus quaerat commodi ab fuga. Tempora illo rem itaque earum hic, obcaecati, corrupti ducimus blanditiis sed incidunt non natus.</p>
        </div>
